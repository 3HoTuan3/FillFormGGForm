...
def main():
    ...
    def scroll_to(element):
        # TẮT SCROLL - CHỈ GIỮ LẠI ĐỂ TƯƠNG THÍCH CODE
        pass
    ...
    def process_page_3_logic():
        ...
        # Câu 2: Tuổi - 80% cho độ tuổi trẻ (0,1,2), 20% cho độ tuổi lớn (3,4)
        def pick_age_idx():
    ...
    try:
        ...
        print("➡️ Đang bấm 'Tiếp' (Next) ở trang 5 để sang trang Gửi...")
        nav_result = nav()
        if nav_result:
        ...
        try:
            ...
            time.sleep(0.5)  # GIẢM TỪ 2s XUỐNG 1s
        except Exception:
            print(
